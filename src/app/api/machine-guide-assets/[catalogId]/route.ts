import { canonicalPWorldImageUrl,isVisualGuidePilotCatalog } from "@/lib/machine-guide/visualGuide";
...
export async function GET(request:Request,{params}:{params:Promise<{catalogId:string}>}){
  ...
  if(!isVisualGuidePilotCatalog(catalogId)||!source)return new Response("Not found",{status:404});
