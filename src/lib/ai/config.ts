...
export const AI_CONFIG = {
  ...
  openAISelectionModel: process.env.OPENAI_SLOT_SELECTION_MODEL || process.env.OPENAI_SESSION_COMPANION_MODEL || process.env.OPENAI_MACHINE_GUIDE_MODEL || process.env.OPENAI_MACHINE_IDENTIFICATION_MODEL || "gpt-5.4-mini",
