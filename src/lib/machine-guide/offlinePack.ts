...
export function offlinePackUrls(guides:MachineGuide[],covers:OfflinePackCover[]=[]){return[...new Set(["/","/start","/catalog","/records","/identify","/halls","/glossary","/help",...guides.flatMap(guideOfflineUrls),...covers.map(coverOfflineUrl)])]}
